...
describe('Balance Analysis', () => {
  ...
  describe('Traditional vs Streaming Comparison', () => {
    ...
    it('mid career: streaming becomes competitive with catalogue', () => {
      ...
      const songs = [
        { id: 'song1', title: 'Hit 1', quality: 70, style: 'rock' as const, hitPotential: 65,
        ...
        { id: 'song2', title: 'Hit 2', quality: 65, style: 'rock' as const, hitPotential: 60,
        ...
        { id: 'song3', title: 'Deep Cut', quality: 55, style: 'rock' as const, hitPotential: 40,
